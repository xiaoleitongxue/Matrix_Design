...
bool CompareArrays(const std::array<T, N> arr1, const std::array<T, N> arr2, int size) {
...
int sum(int const& value1, int const& value2)
{
    return value1 + value2;
}

TEST(Matrix_design_test, Simple_test){
    sum(1,2);
}
